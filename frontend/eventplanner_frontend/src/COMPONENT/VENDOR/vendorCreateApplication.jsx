...
export default function VendorCreateApplication() {
  ...
  const handleSignUp = (e) => {
    ...
    axios
      .post('http://localhost:7076/registervendor', form)
      .then((res) => {
        console.log(res)
  ...
  return (
    <div>
      <title>Vendor's Create Account</title>
      <meta name="viewport" content="width=device-width, initial-scale=1" />
      <form id="formn" onSubmit={handleSignUp}>
        <h2 id="hn">Vendor Create Account</h2>
        ...
        <div className="form-footer">
          <a href="/VendorLog">Already have an account? back to login</a>
        </div>
      </form>
    </div>
  )
